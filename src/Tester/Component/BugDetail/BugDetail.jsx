				...
				<div className={cx("left-column")}>
					<div className={cx("bug-container")}>
						<div className={cx("url")}>
							<h3>URL: </h3>
							<p>https://coresite-stage.tsc-starts-coding.com/coresite/mattresses/compare</p>
						</div>
						<div className={cx("results")}>
							<h3>Actual Result</h3>
							<p className={cx("actual-result")}>
								After clicking on "Back pain" in the "Quick Comparison" section, the user is back to the top of the page but the "Back
								pain" option is not highlighted.
							</p>
								...
								<div className={cx("comment")}>
									<div className={cx("comment-avatar")}>
										...
										<span className={cx("comment-time")}>
											<strong>Victor (TL)</strong> May 3, 2024 10:30 PM
										</span>
									</div>
									<div className={cx("comment-content")}>
										Please note that each bug may only be submitted once. If two bugs have the same root cause, only the first
										report
									</div>
								</div>
								<div className={cx("comment")}>
